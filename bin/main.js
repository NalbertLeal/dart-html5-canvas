// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.10.1.
...
(function dartProgram() {
  ...
  P = {
    ...
    _schedulePriorityAsyncCallback: function(callback) {
      var newEntry, lastCallback, entry, lastPriorityCallback, next,
        t1 = $._nextCallback;
      if (t1 == null) {
        newEntry = new P._AsyncCallbackEntry(callback);
  ...
  O = {
    ParticlesSphere$: function(canvasHtmlId) {
      var t1 = new O.ParticlesSphere(H.setRuntimeTypeInfo([], type$.JSArray_legacy_Dot));
      t1.ParticlesSphere$1(canvasHtmlId);
      return t1;
    },
    ParticlesSphere: function ParticlesSphere(t0) {
      var _ = this;
      _.dots = t0;
      _.projection_center_y = _.projection_center_x = _.perspective = _.canvasContext = _.canvasElement = null;
    },
    ParticlesSphere_closure: function ParticlesSphere_closure(t0) {
      this.$this = t0;
    }
  },
  F = {
  ...
  O.ParticlesSphere.prototype = {
    ParticlesSphere$1: function(canvasHtmlId) {
      ...
      if (typeof t2 !== "number")
        return t2.$mul();
      _this.perspective = t2 * 0.8;
      t2 = t1.width;
      if (typeof t2 !== "number")
        return t2.$div();
      _this.projection_center_x = t2 / 2;
      t1 = t1.height;
      if (typeof t1 !== "number")
        return t1.$div();
    ...
    onResize$0: function(_) {
      var t1 = this.canvasElement,
        width = C.JSNumber_methods.round$0(t1.offsetWidth),
        height = C.JSNumber_methods.round$0(t1.offsetHeight),
      ...
      if (t2 > 1) {
        ...
        if (typeof t2 !== "number")
          return t2.$mul();
        C.CanvasElement_methods.set$height(t1, t2 * 2);
        t2 = this.canvasElement;
        t1 = t2.clientWidth;
        if (typeof t1 !== "number")
          return t1.$mul();
        C.CanvasElement_methods.set$width(t2, t1 * 2);
      } else {
        C.CanvasElement_methods.set$width(t1, width);
        t1 = this.canvasElement;
    ...
    render$1: function(_) {
      ...
      t2 = W._wrapZone(t2, type$.num);
      t2.toString;
      C.Window_methods._requestAnimationFrame$1(t1, t2);
    }
  };
  O.ParticlesSphere_closure.prototype = {
    call$1: function(_) {
      type$.legacy_Event._as(_);
      return this.$this.onResize$0(0);
    },
    $signature: 9
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(O.ParticlesSphere.prototype, "get$render", "render$1", 8);
  })();
  (function inheritance() {
    ...
    _inheritMany(P.Error, [P.TypeError, H.JsNoSuchMethodError, H.UnknownJsTypeError, H.RuntimeError, H._Error, P.AssertionError, P.NullThrownError, P.ArgumentError, P.UnsupportedError, P.UnimplementedError, P.ConcurrentModificationError, P.CyclicInitializationError]);
    _inherit(H.NullError, P.TypeError);
    _inheritMany(H.Closure, [H.TearOffClosure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, P._AsyncRun__initializeScheduleImmediate_internalCallback, P._AsyncRun__initializeScheduleImmediate_closure, P._AsyncRun__scheduleImmediateJsOverride_internalCallback, P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, P._TimerImpl_internalCallback, P._rootHandleUncaughtError_closure, P._RootZone_bindUnaryCallbackGuarded_closure, O.ParticlesSphere_closure]);
  ...
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","JSBool":{"bool":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[]},"JSDouble":{"double":[],"num":[]},"JSString":{"String":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]}}'));
  0;
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_legacy_Dot: findType("JSArray<Dot*>"),
      ...
      int: findType("int"),
      legacy_CanvasElement: findType("CanvasElement*"),
      legacy_CanvasRenderingContext2D: findType("CanvasRenderingContext2D*"),
